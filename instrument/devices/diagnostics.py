...
class PSS_Parameters(Device):
    a_beam_active = Component(EpicsSignalRO, "PA:20ID:A_BEAM_ACTIVE.VAL", string=True)
    a_shutter_open_chain_A_led = Component(EpicsSignalRO, "PA:20ID:STA_A_FES_OPEN_PL", string=True)

    b_beam_active = Component(EpicsSignalRO, "PA:20ID:B_BEAM_ACTIVE.VAL", string=True)
    b_beam_ready = Component(EpicsSignalRO, "PA:20ID:B_BEAM_READY.VAL", string=True)
    b_shutter_closed_chain_B = Component(EpicsSignalRO, "PB:20ID:STA_B_SBS_CLSD_PL", string=True)
    b_shutter_open_chain_A = Component(EpicsSignalRO, "PA:20ID:STA_B_FES_OPEN_PL", string=True)
